...
public class AppPreference {
    ...
    private static final String APP_PREFENCE = "preferences_GSP";
     ...
     *
     * */
    private static final String SPECIAL_PREFS = "app_special_prefs";

    public static void setVersionPreference(Context context, String key, boolean value) {
        SharedPreferences preferences = context.getSharedPreferences(SPECIAL_PREFS, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean(key, value);
        editor.commit();
    }

    public static boolean getVersionPreference(Context context, String key) {
        SharedPreferences preferences = context.getSharedPreferences(SPECIAL_PREFS, Context.MODE_PRIVATE);
        return preferences.getBoolean(key, false);
    }
